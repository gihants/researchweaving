...
$this->title = 'Risk of bias of reviews';
$this->params['breadcrumbs'][] = $this->title;



?>
<script src="https://code.highcharts.com/highcharts.js"></script><script src="https://code.highcharts.com/modules/exporting.js"></script><script src="https://code.highcharts.com/modules/export-data.js"></script></head><body><h4></h4>
<p>Quality assessment of the review articles was performed using
    modified AMSTAR (<a
            ...
            href="https://systematicreviewsjournal.biomedcentral.com/articles/10.1186/s13643-016-0237-1">Burda,
        Holmer and Noris 2016</a><sup>1</sup>; <a
            title="Development of AMSTAR: a measurement tool to assess the methodological quality of systematic reviews"
            href="https://bmcmedresmethodol.biomedcentral.com/articles/10.1186/1471-2288-7-10">Shea
        et al. 2007</a><sup>2</sup>) and AMSTAR-2 (<a
            ...
            href="https://www.bmj.com/content/358/bmj.j4008.full">Shea et al.2017</a><sup>3</sup>)
...
<p>Based on the scoring for 16 questions&nbsp;and also based on the
    subjective overall evaluation of the assessors, an overall rating (<span
            style="font-weight: bold;">Quality&nbsp;Index</span>)
    ...
    overall conclusions of the review article.Then a <span
            style="font-weight: bold;">risk of bias</span> score was assigned to
...
improvement.<span>&nbsp;</span></span><i
                style="color: rgb(34, 34, 34); font-family: Arial,sans-serif; font-size: 13px; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(255, 255, 255);">Systematic
            reviews</i><span
                style="color: rgb(34, 34, 34); font-family: Arial,sans-serif; font-size: 13px; font-style: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(255, 255, 255); display: inline ! important; float: none;">,<span>&nbsp;</span></span><i
                style="color: rgb(34, 34, 34); font-family: Arial,sans-serif; font-size: 13px; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(255, 255, 255);">5</i><span
...
quality of systematic reviews.<span>&nbsp;</span></span><i
                style="color: rgb(34, 34, 34); font-family: Arial,sans-serif; font-size: 13px; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(255, 255, 255);">BMC
            medical research methodology</i><span
                style="color: rgb(34, 34, 34); font-family: Arial,sans-serif; font-size: 13px; font-style: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(255, 255, 255); display: inline ! important; float: none;">,<span>&nbsp;</span></span><i
                style="color: rgb(34, 34, 34); font-family: Arial,sans-serif; font-size: 13px; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(255, 255, 255);">7</i><span
                style="color: rgb(34, 34, 34); font-family: Arial,sans-serif; font-size: 13px; font-style: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(255, 255, 255); display: inline ! important; float: none;">(1),
p.10.</span></li>
    <li>
        <meta http-equiv="content-type" content="text/html; charset=utf-8">
...
both.<span>&nbsp;</span></span><i
                style="color: rgb(34, 34, 34); font-family: Arial,sans-serif; font-size: 13px; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(255, 255, 255);">bmj</i><span
                style="color: rgb(34, 34, 34); font-family: Arial,sans-serif; font-size: 13px; font-style: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(255, 255, 255); display: inline ! important; float: none;">,<span>&nbsp;</span></span><i
                style="color: rgb(34, 34, 34); font-family: Arial,sans-serif; font-size: 13px; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(255, 255, 255);">358</i><span
                style="color: rgb(34, 34, 34); font-family: Arial,sans-serif; font-size: 13px; font-style: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(255, 255, 255); display: inline ! important; float: none;">,
p.j4008.</span></li>
</ol>


<p>The following diagram presents the distribution of risk of bias among included review articles.</p>
<div id="container_3" style="margin: 0pt auto; min-width: 310px; max-width: 1000px; height: 800px;"></div>
<p>&nbsp;</p>
        ...
        series: [ {
            ...
            events: {
                click: function (event) {
                    ...
                    var url_to = <?php echo json_encode(Url::to(['material-info-view/risk-of-bias'])); ?>;
                    console.log(url_to);
                    var new_url = url_to.concat('&risk_level=', 'high');
            ...
            events: {
                click: function (event) {
                    ...
                    var url_to = <?php echo json_encode(Url::to(['material-info-view/risk-of-bias'])); ?>;
                    console.log(url_to);
                    var new_url = url_to.concat('&risk_level=', 'medium');
                    var win = window.open(new_url, '_blank');
                    win.focus();
                }
            }
            ...
            events: {
                click: function (event) {
                    ...
                    var url_to = <?php echo json_encode(Url::to(['material-info-view/risk-of-bias'])); ?>;
                    console.log(url_to);
                    var new_url = url_to.concat('&risk_level=', 'low');
                    var win = window.open(new_url, '_blank');
                    win.focus();
                }
            }
