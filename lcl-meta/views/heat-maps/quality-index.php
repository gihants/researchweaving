...
<p>The following diagram presents the distribution of <span style="font-weight: bold;">Quality Index</span> among included review
articles.</p>
<div id="container_2" style="margin: 0pt auto; min-width: 310px; max-width: 1000px; height: 800px;"></div>
<p>&nbsp;</p>
<br>
        ...
        series: [ {
            ...
            events: {
                click: function (event) {
                    ...
                    var url_to = <?php echo json_encode(Url::to(['material-info-view/quality-index'])); ?>;
                    console.log(url_to);
                    var new_url = url_to.concat('&quality_index=', 'C');
            ...
            events: {
                click: function (event) {
                    ...
                    var url_to = <?php echo json_encode(Url::to(['material-info-view/quality-index'])); ?>;
                    console.log(url_to);
                    var new_url = url_to.concat('&quality_index=', 'B');
                    var win = window.open(new_url, '_blank');
                    win.focus();
                }
            }
            ...
            events: {
                click: function (event) {
                    ...
                    var url_to = <?php echo json_encode(Url::to(['material-info-view/quality-index'])); ?>;
                    console.log(url_to);
                    var new_url = url_to.concat('&quality_index=', 'A');
                    var win = window.open(new_url, '_blank');
                    win.focus();
                }
            }
