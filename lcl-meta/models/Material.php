 ...
 * @property BuiltEnvironmetType[] $builtEnvironmentTypes
...
class Material extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['review_type_id', 'risk_type_id', 'geographic_focus', 'prisma_diagram_used', 'no_of_original_sources', 'systhesis_method_id', 'scale_id', 'material_type_id'], 'integer'],
            [['title'], 'string', 'max' => 500],
            [['main_topic', 'screening_criteria', 'conflict_of_interest'], 'string', 'max' => 2000],
            [['conclusions', 'comments'], 'string', 'max' => 5000],
    ...
    {
        return $this->hasMany(MaterialHasBuiltEnvironmetType::className(), ['material_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(BuiltEnvironmetType::className(), ['id' => 'built_environment_type_id'])->viaTable('material_has_built_environmet_type', ['material_id' => 'id']);
    }
